    ...
    <div class="container">
        <div class="col-xs-12 col-sm-4 col-md-4 text-left fade-in">
            ...
            <ul class="list-unstyled list-inline">
                ...
                <li>
                    <a href="sitemap.html" target="_blank" title="" data-toggle="tooltip" data-placement="bottom" data-original-title="网站地图"><i class="fa fa-map-o fa-fw"></i>网站地图</a>
                </li>
                <li>
                ...
                <li>
                    <a href="archives.html" title="" data-toggle="tooltip" data-placement="bottom" data-original-title="归档目录"><i class="fa fa-folder-o fa-fw"></i>归档目录</a>
                </li>
                <li>
                ...
                <li>
                    <a href="disclaimer.html" title="" data-toggle="tooltip" data-placement="bottom" data-original-title="免责声明"><i class="fa fa-file-o fa-fw"></i>免责声明</a>
                </li>
            </ul>
        </div>
        <div class="col-xs-12 col-sm-4 col-md-4 text-left fade-in">
        ...
        <div class="col-xs-12 col-sm-4 col-md-4 text-left fade-in">
            ...
            <div class="row" style="padding: 4px;padding-left: 10px;">
                ...
                <div class="col-xs-12 col-sm-5 col-md-5">
                    <a href="./img/qq_group.png" class="showImage" title="QQ群(190886500)二维码" rel="external nofollow">
                        <img data-original="./img/qq_group.png" alt="QQ群(190886500)二维码" class="img-responsive img-rounded auto-shake lazy-img" style="width: 100px;">
                    </a>
                </div>
            </div>
        </div>
